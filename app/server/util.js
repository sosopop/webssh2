...
exports.basicAuth = function basicAuth(req, res, next) {
  ...
  if (req.query.user && req.query.pass) {
    ...
    req.session.proxy = req.query.proxy;
    req.session.proxyPort = req.query["proxy-port"];
    req.session.proxyUser = req.query["proxy-user"];
    req.session.proxyPass = req.query["proxy-pass"];
  }
